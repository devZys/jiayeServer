...
namespace LegendProtocol
{
    ...
    public class ServerUtil
    {
        ...
        static public void PrintLog(LogType logType, string context, StackFrame stackFrame = null)
        {
            switch (logType)
            {
                case LogType.Info:
        ...
        static public void PrintLog(LogType logType, Exception ex, StackFrame stackFrame = null)
        {
            switch (logType)
            {
                case LogType.Info:
