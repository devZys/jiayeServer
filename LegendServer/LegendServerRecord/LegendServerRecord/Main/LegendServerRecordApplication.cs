...
{
    public class LegendServerRecordApplication : ApplicationBase
    {
        ...
        protected override void Setup()
        {
            ...
            {
                ServerUtil.RecordLog(LogType.Fatal, "Record读取本地配置出错！！！", new StackTrace(new StackFrame(true)).GetFrame(0));
                return;
            }
