...
namespace LegendServerRecord.Distributed
{
    public class DistributedMsgProxy : ServerMsgProxy
    {
        ...
        public void OnNotifyCloseService(int peerId, bool inbound, object msg)
        {
            ...
            LegendServerRecordApplication.StopService();
        }
        ...
        public void OnReplyDBConfig(int peerId, bool inbound, object msg)
        {
            ...
            {
                ServerUtil.RecordLog(LogType.Fatal, "Record 数据库加载至缓存出错," + result, new StackTrace(new StackFrame(true)).GetFrame(0));
                return;
            }
