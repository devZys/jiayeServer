...
namespace LegendServerProxy.Core
{
    ...
    public class ServerRegister
    {
        ...
        //尝试注册被动连接进来的服务器
        public InboundServerPeer TryRegistServer(InitRequest initRequest)
        {
            lock (registerLocker)
            {
                ...
                {
                    return ServerUnLoadAllowEstablishSocket ? new InboundServerPeer(initRequest, fromName, fromId) : null;
                }
                ...
                return new InboundServerPeer(initRequest, fromName, fromId);
            }
        }
    }
}
