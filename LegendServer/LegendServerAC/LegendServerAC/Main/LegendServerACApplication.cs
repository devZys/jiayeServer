...
namespace LegendServerAC
{
    public class LegendServerACApplication : ApplicationBase
    {
        ...
        protected override void Setup()
        {
            ...
            {
                ServerUtil.RecordLog(LogType.Fatal, "AC读取本地配置出错！！！", new StackTrace(new StackFrame(true)).GetFrame(0));
                return;
            }
