...
using LegendServerLogic.SafeCheck;
...
{
    public class LegendServerLogicPeer : PeerBase
    {
        public readonly IFiber sendMsgFiber;
        public readonly IFiber recvMsgFiber;
        public LegendServerLogicApplication serverRoot;

        public LegendServerLogicPeer(IRpcProtocol rpcProtocol, IPhotonPeer nativePeer, LegendServerLogicApplication server)
