...
namespace LegendServer.Util
{
    ...
    public enum TimerId
    {
        ...
        InternalServerConnectedCheck,//内部服务器是否已连接的检测计时器
        ServiceStopKeyCheck,//服务中止key的检测计时器
        updateDataToDB,//测试数据库写入计时器
        DelayReconnectServerCheck,
        UpdateActualCCU,//更新真实CCU
        HouseVote, //房间投票
        HouseAutomaticOperate, //房间自动操作
        HouseAction,//房间行为
        MarketsCompetitionCheck, //商家比赛场
        MarketsCompetitionEndCheck, //商家比赛场结束
    }
    //计时器状态
