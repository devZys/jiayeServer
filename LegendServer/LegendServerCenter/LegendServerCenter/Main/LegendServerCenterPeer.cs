...
using LegendServerCenter.SafeCheck;
...
{
    public class LegendServerCenterPeer : PeerBase
    {
        public readonly IFiber sendMsgFiber;
        public readonly IFiber recvMsgFiber;
        public LegendServerCenterApplication serverRoot;

        public LegendServerCenterPeer(IRpcProtocol rpcProtocol, IPhotonPeer nativePeer, LegendServerCenterApplication server)
