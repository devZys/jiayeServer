    ...
    public class ServerRegister
    {
        ...
        public InboundPeer TryRegistServer(InitRequest initRequest)
        {
            lock (registerLocker)
            {
                ...
                if (ModuleManager.Get<DistributedMain>().ServerStatus == ServerInternalStatus.UnLoaded || ModuleManager.Get<DistributedMain>().ServerStatus == ServerInternalStatus.Closed)
                {
